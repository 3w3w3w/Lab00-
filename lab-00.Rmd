...
We've set up the data frame. Edit the data below to include information about your team members.

```{r setup-tibble}
team_data <- tibble(
  name = c("Ivy", "Fola", "Manya", 
           "Seyara", "Doa"),
  github_username = c("seyara-g", "fola/ed", "manya/10", 
                      "ivymowx", "doga2424"), 
  colour = c("pink", "red", "blue", 
             "blue", "red"),
  hobby = c("dancing", "basketball", "football", 
            "music", "piano"),
  favourite_number = c(8, 6, 10, 7, 6)
  )
